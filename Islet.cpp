...
void Islet::initialize(const char * fileChars)
{	
...
double Islet::get_ktt() const
{
	return ktt;
}

double Islet::get_kdd() const
{
	return kdd;
}

double Islet::get_ktd() const
{
	return ktd;
}
